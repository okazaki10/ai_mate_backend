...
RVC_DIR = os.path.dirname(__file__)
...
def on_button_click(audio,file_index,outputFile,pitch=0,crepeHopLength=128,method="crepe",retrievalRate=0.4):
    ...
    index_rate = round(retrievalRate,2)
    global output_file
