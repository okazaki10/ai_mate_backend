...
def g2p_id(text):
    """
    Indonesian G2P function with token mapping
    ...
    Example:
        >>> g2p_id("Selamat pagi")
        '<sos/eos> [S] [AH0] [L] [AA1] [M] [AA1] [T] [P] [AA1] [G] [IY1] <sos/eos>'
    """
    ...
    # Map phonemes to available tokens
    tokens = []
...
def g2p_id_formatted(text, word_separator=" ", phoneme_wrapper=""):
    """
    Customizable Indonesian G2P function with token mapping
