...
if __name__ == "__main__":
    ...
    run_cmd(f"conda install -y ninja git && python -m pip install torch==2.7.1 torchvision torchaudio --index-url https://download.pytorch.org/whl/cu128 && python -m pip install py-cpuinfo==9.0.0", assert_success=True, environment=True)
