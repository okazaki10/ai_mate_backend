...
set CMAKE_ARGS="-DGGML_CUDA=on" && %DIR%\installer_files\env\python -m pip install llama-cpp-python==0.3.9 --upgrade --force-reinstall --no-cache-dir
@REM %DIR%\installer_files\env\python -m pip install https://github.com/okazaki10/llama-cpp-python/releases/download/0.3.9/llama_cpp_python-0.3.9-cp311-cp311-win_amd64.whl
